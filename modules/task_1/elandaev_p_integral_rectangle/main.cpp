...
//    //std::function<double(double, double)> f = f1;
//    //std::function<double(double, double, double, double, double, double)> fsec = f2;
//    //std::function<double(double)> fn = f3;
//    //double k = Integralsec(0.0, 16.0, 0.0, 16.0, 0.001, fsec);
//    double a = RectangleIntegral(0.0, 10.0, f4, 0.0001);
//    std::cout << a;
//    return 1;
//}
